...
class PostController extends Controller
{
	...
	public function postUpdatePost(Request $request)
	{
        ...
        if(strlen($request['categories'])>0) {
         ...
         return redirect()->route('admin.index')->with(['success' => 'Post suceessfully updated!']);
	...
	public function postCreatePost(Request $request) 
	{
         ...
         return redirect()->route('admin.index')->with(['success' => 'Post suceessfully created!']);
	...
	public function getDeletePost($post_id)
	{
        ...
        $post->delete();
        return redirect()->route('admin.index')->with(['success' => 'Post suceessfully deleted!']);		
	}
